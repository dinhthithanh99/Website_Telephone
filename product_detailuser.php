...
<head>
    <title>WEBSITE TELEPHONES</title>
...
<li><a href="show_cart1.php" class="fa fa-shopping-cart" style="font-size: 15px;color: black">Add to cart<span class=""><b style="color:red"> (<?php $sql4 = "SELECT * FROM Guest";      //SQL querry

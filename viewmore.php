...
if (!isset($_SESSION["uid"])) {
  header("location:viewmoreindex.php");
}
?>
<!DOCTYPE html>
<html>
            ...
            <li class="dropdown">
              <a class="dropdown-toggle" data-toggle="dropdown" href="#">Category
                ...
                <ul class="nav navbar-nav navbar-right" >
                  ...
                  <li><a href="show_cart1.php" class="fa fa-shopping-cart" style="font-size: 15px;color: black">Add to cart<span class=""><b style="color:red"> (<?php 
          ...
          <div class="menu-thumb">
            <a href="#" class="image-popup" title="Samsung">
              ...
              <div class="menu-info">
                <div class="menu-item">
                  <?php 
                                    echo "<a href='product_detailuser.php?id=" . $row['id'] . "'><span>Detail</span></a>";
                                    ?>
